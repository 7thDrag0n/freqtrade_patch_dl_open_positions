...
file_modifications = [
    ...
    {
        "file_path": "freqtrade/optimize/hyperopt/hyperopt.py",
        "function_name": "_save_result",
        "insert_after_line": ":param epoch: result dictionary for this epoch.",
        "code_to_insert": """\
        
        #7thDragon##########
        # Skip writing epochs with 0 trades
...
def modify_file(file_info):
    ...
    if import_statement and import_statement not in content:
        ...
        print(f"No import statement needed for '{file_path}'.")
